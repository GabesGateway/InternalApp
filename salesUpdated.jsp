...
%>
    ...
    <body style="background:  #222;">
      ...
      <hr style="height:2px; width:100%; border-width:0; color:rgb(255, 255, 255); background-color:rgb(255, 255, 255); margin-top: 89px;">
        ...
        <div class="container">
            <h1 style="color: white; text-align: center; padding-bottom: 20px;">| Sales Report |</h1>
            <div class="row">
                <div class="col-12">
                    <div class="data_table">
                        <table id="example" class="table table-striped table-bordered" style="box-shadow: 0 0 10px 0 #045164;">
                            ...
                            <tbody>
                                ...
                                String str = "select * from product_sales";
...
<td> </td>
<td><strong>$<%=rs.getString("total_profit") %></strong></td>
